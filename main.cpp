...
/*   Updated: 2021/12/24 18:34:20 by sqatim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <typename T>
void print_namespace(ft::set<T> const &mp)
{
    mp.empty();
    std::cout << "\nNAMESPACE : ft" << std::endl;
}
...
template <typename T>
void print_namespace(std::set<T> const &mp)
{
    mp.empty();
    std::cout << "\nNAMESPACE : std" << std::endl;
}
...
template <typename T>
void print_set(NS::set<T> &mp, char const *label)
{
    std::cout << "\nset Size: " << mp.size();
    std::cout << "\nset [" << label << "] contains: ";
    if (!mp.size())
        ...
        std::cout << "\n\n";
    for (typename NS::set<T>::iterator it = mp.begin(); it != mp.end(); ++it)
    {
...
int main(void)
{
    ...
    if(SET)
    {
        std::cout << "<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< set tests >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n"
              << std::endl;
    NS::set<int> settGolbal;
    print_namespace(settGolbal);
    ...
    // // // set constructors
    {
        ...
        print_set(set2, "set2");
        NS::set<int> set3(set2.begin(), set2.end());
        print_set(set3, "set3");
        std::cout << "=======================================" << std::endl;
    }
